import { confirmCourseCheckoutApi, createCourseCheckoutApi, deleteCourseApi, getCourseApi, getProfileByIdApi, getSubscriptionApi, subscribeCourseApi, udpateCourseApi, uploadCourseThumbnailApi } from "@/features/courses/api";
