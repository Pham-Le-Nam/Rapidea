import { addEducationApi, deleteEducationApi, getEducationApi, updateEducationApi } from "@/features/profile/api";
...
import { DEFAULT_EDUCATION_LOGO_URL } from "@/shared/lib/media";
import {
    ProfileItemImage,
...
function EditEducation({ education, reloadEducation }: EditEducationProps) {
    ...
    const submit = async () => {
        try {
            ...
            toast.error(getProfileApiErrorMessage(error, "Could not update education"));
        }
    }
