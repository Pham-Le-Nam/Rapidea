...
import { addExperienceApi, deleteExperienceApi, getExperienceApi, updateExperienceApi } from "@/features/profile/api";
...
import { DEFAULT_EXPERIENCE_LOGO_URL } from "@/shared/lib/media";
import {
    ProfileItemImage,
...
function EditExperience({ experience, reloadExperience }: EditExperienceProps) {
    ...
    const submit = async () => {
        try {
            ...
            toast.error(getProfileApiErrorMessage(error, "Could not update experience"));
        }
    }
