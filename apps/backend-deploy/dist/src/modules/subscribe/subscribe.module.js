...
const prisma_subscribe_repository_1 = require("../../database/prisma/prisma-subscribe.repository");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            subscribe_service_1.SubscribeService,
            {
                ...
                useClass: prisma_subscribe_repository_1.PrismaSubscribeRepository,
            },
        ],
    })
], SubscribeModule);
