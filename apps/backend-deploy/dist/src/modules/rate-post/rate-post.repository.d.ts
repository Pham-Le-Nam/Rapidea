export interface RatePostRepository {
    ...
    findPostSummary(postId: string): Promise<any | null>;
    findOwnedRating(id: string, userId: string): Promise<any | null>;
    findPostAccess(postId: string, userId: string): Promise<any | null>;
}
