...
const prisma_tags_repository_1 = require("../../database/prisma/prisma-tags.repository");
...
exports.TagsModule = TagsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tags_service_1.TagsService, { provide: 'TAGS_REPOSITORY', useClass: prisma_tags_repository_1.PrismaTagsRepository }],
